...
public class RestaurantControllerMVCTests {
    ...
    public void getRestaurantById_andReturnStatus200() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get("/restaurants/1"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", is(1)))
                .andExpect(jsonPath("$.name", is("Test1")));

        this.mockMvc.perform(MockMvcRequestBuilders.get("/restaurants/2"))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    public void createNewRestaurant_andReturnStatus200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$",is(String.format("Restaurant with name: %s has been successfully created!",restaurant.getName()))));
    }
    @Test
    public void updateRestaurant_andReturnStatus200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$",is(String.format("Restaurant with id: %d has been successfully updated!",restaurant.getId()))));
    }
    ...
    public void deleteRestaurant_andReturnStatus200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$",is("Restaurant with id: 1 has been successfully deleted!")));
    }
